  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      ...
      trailing: SingleChildScrollView(
        child: Column(
          children: [
            Text(surah.nameArabic, style: textTheme.titleSmall),
            Text('${surah.versesCount} Ayahs', style: textTheme.titleSmall),
          ],
        ),
      ),
      onTap: () {
...
String getMalayalamMeaning(String englishMeaning) {
